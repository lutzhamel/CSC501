...
\AxiomC{}
\UnaryInfC{$( a_0, \sigma') \mapsto k_0$}
\BinaryInfC{$( a_1 + a_0, \sigma') \mapsto k_1 + k_0 = k_0 + k_1$}
\end{prooftree}
}
...
\begin{frame}{Expression Equivalence}
As in the case of \syntaxset{Aexp}, our notion of semantic value for expressions leads to an equivalence relation
